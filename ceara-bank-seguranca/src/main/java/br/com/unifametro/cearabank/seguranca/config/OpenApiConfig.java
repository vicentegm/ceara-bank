...
@OpenAPIDefinition(
    ...
    info = @Info(
        ...
        description = "API responsável pela autenticação (Login) e gestão inicial de usuários (Registro) para os demais microsserviços do Ceará Bank. Maxo Vehi!", // Descrição Ceara!
        contact = @Contact(
    ...
    servers = {
        @Server(url = "http://localhost:8082", description = "Servidor Local (Desenvolvimento)"),
